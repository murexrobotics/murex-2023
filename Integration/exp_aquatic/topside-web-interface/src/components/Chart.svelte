...
<canvas id="tempChart" bind:this={tempChart}></canvas>
<canvas id="gasChart" bind:this={gasChart}></canvas>
<canvas id="humidityChart" bind:this={humidityChart}></canvas>
<canvas id="pressureChart" bind:this={pressureChart}></canvas>
<canvas id="altitudeChart" bind:this={altitudeChart}></canvas>